    ...
    >
      ...
      <div className="absolute inset-0">
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(180deg, color-mix(in oklab, black 30%, transparent) 0%, color-mix(in oklab, black 20%, transparent) 40%, color-mix(in oklab, black 75%, transparent) 100%)",
          }}
        />
      </div>
      ...
      <div className="relative z-10 flex min-h-screen flex-col px-6 pb-10 pt-8">
        ...
        <div className="mt-auto">
          ...
          >
            Live, crowd-powered wait times for the city around you.
          </p>
