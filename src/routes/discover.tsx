...
function VenuePanel({
  ...
  // Mirrors the venue sheet from Home — full hero carousel, Directions,
  // Reviews, Recent reports, etc. Reusing VenueDetailBody keeps the two
  // surfaces in sync automatically.
  void onReport;
  return (
    <div className="no-scrollbar flex-1 overflow-y-auto" style={{ overscrollBehavior: "contain" }}>
      <VenueDetailBody
        venue={v}
        heroHeightClass="h-56"
        headerOverlay={
