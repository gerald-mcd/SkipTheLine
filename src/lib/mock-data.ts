...
export const venues: Venue[] = [
  // Real Brickell, Miami establishments. x/y are % positions on the Brickell-centered map.
  { id: "v1", name: "Komodo", category: "restaurants", categoryLabel: "Restaurant", waitMinutes: 42, severity: "long", distance: "0.2 mi", reportsCount: 18, lastReportMinutes: 2, trend: "up", event: "Friday Rush", x: 48, y: 46, hours: "5pm – 2am", address: "801 Brickell Plaza", liveReporters: 6, vibe: "Pan-Asian · Buzzy", image: "https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?w=1200&q=80&auto=format&fit=crop", typicalWaitMinutes: 55, reporterNames: ["Sofía", "Marcus", "Devon", "Aisha", "Tyler", "Maya"], recentQuote: { text: "Seated in 38 — bar moves faster.", author: "Sofía", ago: "2m" } },
  { id: "v2", name: "Sugar Rooftop", category: "entertainment", categoryLabel: "Rooftop Lounge", waitMinutes: 55, severity: "long", distance: "0.4 mi", reportsCount: 31, lastReportMinutes: 1, trend: "up", event: "Sunset DJ set", x: 62, y: 30, hours: "5pm – 2am", address: "788 Brickell Plaza, EAST Hotel", liveReporters: 14, vibe: "Asian garden · Skyline", image: "https://images.unsplash.com/photo-1545128485-c400e7702796?w=1200&q=80&auto=format&fit=crop", typicalWaitMinutes: 60, reporterNames: ["Devon", "Priya", "Rico", "Nina", "Jasmine", "Tyler", "Carlos", "Maya"], recentQuote: { text: "Elevator line is the bottleneck.", author: "Devon", ago: "1m" } },
  { id: "v3", name: "Brickell Barber Shop", category: "barbershops", categoryLabel: "Barbershop", waitMinutes: 8, severity: "short", distance: "0.3 mi", reportsCount: 5, lastReportMinutes: 4, trend: "down", x: 40, y: 58, hours: "9am – 8pm", address: "1450 Brickell Ave", liveReporters: 2, vibe: "Classic cuts", image: "https://images.unsplash.com/photo-1503951914875-452162b0f3f1?w=1200&q=80&auto=format&fit=crop", typicalWaitMinutes: 20, reporterNames: ["Marcus", "Theo"], recentQuote: { text: "Walked right in. Chair open.", author: "Marcus", ago: "4m" } },
  { id: "v4", name: "Whole Foods Brickell", category: "grocery", categoryLabel: "Grocery", waitMinutes: 12, severity: "moderate", distance: "0.3 mi", reportsCount: 22, lastReportMinutes: 6, trend: "flat", x: 52, y: 62, hours: "7am – 10pm", address: "299 SE 3rd St", liveReporters: 9, vibe: "Self-checkout open", image: "https://images.unsplash.com/photo-1542838132-92c53300491e?w=1200&q=80&auto=format&fit=crop", typicalWaitMinutes: 10, reporterNames: ["Carlos", "Nina", "Theo", "Priya"], recentQuote: { text: "Self-checkout zero wait.", author: "Carlos", ago: "6m" } },
  { id: "v5", name: "La Mar by Gastón Acurio", category: "restaurants", categoryLabel: "Peruvian", waitMinutes: 25, severity: "moderate", distance: "0.5 mi", reportsCount: 12, lastReportMinutes: 3, trend: "down", x: 70, y: 50, hours: "12pm – 11pm", address: "500 Brickell Key Dr", liveReporters: 4, vibe: "Waterfront · Ceviche", image: "https://images.unsplash.com/photo-1559339352-11d035aa65de?w=1200&q=80&auto=format&fit=crop", typicalWaitMinutes: 45, reporterNames: ["Aisha", "Rico", "Sofía", "Jasmine"], recentQuote: { text: "Dropped 15 min in the last half hour.", author: "Aisha", ago: "3m" } },
  { id: "v6", name: "Pura Vida Brickell", category: "restaurants", categoryLabel: "Café", waitMinutes: 9, severity: "short", distance: "0.2 mi", reportsCount: 8, lastReportMinutes: 5, trend: "flat", x: 44, y: 50, hours: "7am – 9pm", address: "1000 Brickell Ave", liveReporters: 3, vibe: "Healthy · Acai", image: "https://images.unsplash.com/photo-1565299585323-38d6b0865b47?w=1200&q=80&auto=format&fit=crop", typicalWaitMinutes: 12, reporterNames: ["Maya", "Tyler", "Devon"], recentQuote: { text: "Order ahead, walk in, leave.", author: "Maya", ago: "5m" } },
  { id: "v7", name: "Brickell City Centre", category: "retail", categoryLabel: "Shopping", waitMinutes: 18, severity: "moderate", distance: "0.4 mi", reportsCount: 14, lastReportMinutes: 2, trend: "up", x: 56, y: 42, hours: "11am – 9pm", address: "701 S Miami Ave", liveReporters: 7, vibe: "Open-air mall · Apple", image: "https://images.unsplash.com/photo-1481437156560-3205f6a55735?w=1200&q=80&auto=format&fit=crop", typicalWaitMinutes: 25, reporterNames: ["Tyler", "Jasmine", "Rico", "Priya"], recentQuote: { text: "Apple Store has a wait — Zara is empty.", author: "Tyler", ago: "2m" } },
  { id: "v8", name: "Brickell Key Park", category: "landmarks", categoryLabel: "Landmark", waitMinutes: 0, severity: "short", distance: "0.7 mi", reportsCount: 9, lastReportMinutes: 8, trend: "flat", x: 78, y: 56, hours: "Sunrise – Sunset", address: "Claughton Island Dr", liveReporters: 5, vibe: "Bayfront loop · Sunset", image: "https://images.unsplash.com/photo-1502920917128-1aa500764cbd?w=1200&q=80&auto=format&fit=crop", typicalWaitMinutes: 0, reporterNames: ["Nina", "Carlos", "Theo"], recentQuote: { text: "Loop is quiet — perfect run.", author: "Nina", ago: "8m" } },
  { id: "v9", name: "Vice City Bean", category: "restaurants", categoryLabel: "Coffee", waitMinutes: 4, severity: "short", distance: "0.3 mi", reportsCount: 3, lastReportMinutes: 12, trend: "flat", x: 36, y: 44, hours: "7am – 6pm", address: "1000 S Miami Ave", liveReporters: 1, vibe: "Specialty espresso", image: "https://images.unsplash.com/photo-1599351431202-1e0f0137899a?w=1200&q=80&auto=format&fit=crop", typicalWaitMinutes: 6, reporterNames: ["Theo"], recentQuote: { text: "One person ahead. Pour-over flowing.", author: "Theo", ago: "12m" } },
];
